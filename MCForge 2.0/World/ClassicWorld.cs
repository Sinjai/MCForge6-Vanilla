...
namespace MCForge.World
{
    ...
    public class ClassicWorld
    {
        ...
        public byte[] UUID;
        public Vector3S Size = new Vector3S();
        ...
        public Vector3S SpawnPos = new Vector3S();
        public Vector2S SpawnRotation = new Vector2S();
        ...
        public void Load()
        {
          ...
          if (FormatVersion != 1)
            ...
            Size.x = Basetag["X"].ShortValue;
            Size.y = Basetag["Y"].ShortValue;
            Size.z = Basetag["Z"].ShortValue;
            ...
            {
                SpawnPos.x = Spawnpoint["X"].ShortValue;
                SpawnPos.y = Spawnpoint["Y"].ShortValue;
                SpawnPos.z = Spawnpoint["Z"].ShortValue;
                SpawnRotation.x = Spawnpoint["H"].ByteValue;
                SpawnRotation.z = Spawnpoint["P"].ByteValue;
            }
