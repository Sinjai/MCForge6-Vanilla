...
namespace MCForge.Utils
{
    ...
    public struct Vector3F : IEquatable<Vector3F>, IComparable<Vector3S>, IComparable<Vector3F>
    {
        ...
        public static Vector3F operator +(Vector3S a, Vector3F b)
        {
            return new Vector3F(a.x + b.X, a.y + b.Y, a.z + b.Z);
        }

        public static Vector3F operator +(Vector3F a, Vector3S b)
        {
            return new Vector3F(a.X + b.x, a.Y + b.y, a.Z + b.z);
        }
        ...
        {
            return new Vector3S((ushort)a.X, (ushort)a.Y, (ushort)a.Z);
        }

        public Vector3S Round()
        {
            return new Vector3S((ushort)Math.Round(X), (ushort)Math.Round(Y), (ushort)Math.Round(Z));
        }

        public Vector3S RoundDown()
        {
            return new Vector3S((ushort)Math.Floor(X), (ushort)Math.Floor(Y), (ushort)Math.Floor(Z));
        }

        public Vector3S RoundUp()
        {
            return new Vector3S((ushort)Math.Ceiling(X), (ushort)Math.Ceiling(Y), (ushort)Math.Ceiling(Z));
        }
